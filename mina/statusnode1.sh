...
AKTIF=" ✅ NODE STATUS MINA : $ADDRESS Aktif "\==" Global number of Accounts: $block_node "\==" Block height: $block_height "\==" Sync status: $status "\==" Next block will be produced in: $block_produce "
