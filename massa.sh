...
# setel vars
jika [ !  $NODENAMA ] ;  kemudian
	read -p " Masukkan nama simpul: " NODENAME
	echo  ' export NODENAME= ' $NODENAME  >>  $HOME /.bash_profile
fi
SEI_PORT=12
jika [ !  $WALLET ] ;  kemudian
	echo  " ekspor WALLET=dompet "  >>  $HOME /.bash_profile
fi
echo  " ekspor SEI_CHAIN_ID=sei-testnet-2 "  >>  $HOME /.bash_profile
echo  " ekspor SEI_PORT= ${SEI_PORT} "  >>  $HOME /.bash_profile
sumber  $HOME /.bash_profile

echo  ' ================================================ = '
echo -e " Nama simpul Anda: \e[1m\e[32m $NODENAME \e[0m "
echo -e " Nama dompet Anda: \e[1m\e[32m $WALLET \e[0m "
echo -e " Nama rantai Anda: \e[1m\e[32m $SEI_CHAIN_ID \e[0m "
echo -e " Port Anda: \e[1m\e[32m $SEI_PORT \e[0m "
echo  ' ================================================ = '
tidur 2

echo -e " \e[1m\e[32m1. Memperbarui paket... \e[0m "  && sleep 1
# perbarui
sudo apt update && sudo apt upgrade -y

echo -e " \e[1m\e[32m2. Menginstal dependensi... \e[0m "  && sleep 1
# paket
...
rm " pergi $ver .linux-amd64.tar.gz "
echo  " export PATH= $PATH :/usr/local/go/bin: $HOME /go/bin "  >>  ~ /.bash_profile
sumber  ~ /.bash_profile
pergi versi

echo -e " \e[1m\e[32m3. Mengunduh dan membuat binari... \e[0m "  && sleep 1
# unduh biner
cd  $HOME
...
# konfigurasi
seid config rantai-id $SEI_CHAIN_ID
seid config keyring-backend tes
simpul konfigurasi seid tcp://localhost: ${SEI_PORT} 657
...
pemangkasan = " kebiasaan "
pruning_keep_recent= " 100 "
pruning_keep_every= " 0 "
pemangkasan_interval= " 50 "
...
echo -e " \e[1m\e[32m4. Memulai layanan... \e[0m "  && sleep 1
# buat layanan
...
[Melayani]
Pengguna= $USER
ExecStart= $( yang seid ) mulai --home $HOME /.sei
...
sudo systemctl aktifkan seid
sudo systemctl restart seid

echo  ' =============== PENGATURAN SELESAI ===================== '
echo -e ' Untuk memeriksa log: \e[1m\e[32mjournalctl -u seid -f -o cat\e[0m '
echo -e " Untuk memeriksa status sinkronisasi: \e[1m\e[32mcurl -s localhost: ${SEI_PORT} 657/status | jq .result.sync_info\e[0m "
