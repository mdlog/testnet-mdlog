...
```
Dengan menjalankan perintah ```Update Node``` anda telah memperbaharui versi node anda dari versi 12 ke versi 13 sekaligus memindahkan wallet dan Node yang ada di versi 12 ke versi 13
